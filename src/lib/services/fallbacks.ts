...
export const FALLBACK_GALLERY: GalleryImage[] = [
  {
    ...
    lookbookOrder: 0,
    lookbookTitle: "Storefront",
    lookbookDescription: "Angel Nails στους Αγίους Αναργύρους",
    lookbookCategory: "Χώρος",
  ...
  },
  {
    ...
    lookbookEnabled: true,
    lookbookOrder: 1,
    lookbookTitle: "Studio Light",
    lookbookDescription: "Ο χώρος του Angel Nails",
    lookbookCategory: "Χώρος",
    lookbookFeatured: true,
    serviceId: null,
    createdAt: new Date(),
  ...
  },
  {
    ...
    lookbookEnabled: true,
    lookbookOrder: 2,
    lookbookTitle: "Nail Detail",
    lookbookDescription: "Λεπτομέρεια nail look",
    lookbookCategory: "Nail Art",
    lookbookFeatured: false,
    serviceId: null,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    lookbookEnabled: true,
    lookbookOrder: 3,
    lookbookTitle: "Atmosphere",
    lookbookDescription: "Premium nail studio atmosphere",
    lookbookCategory: "Χώρος",
    lookbookFeatured: true,
    serviceId: null,
    createdAt: new Date(),
